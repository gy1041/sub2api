export default {
  ...
  profile: {
    ...
    dailyCheckin: {
      ...
      todayReward: '今日奖励',
      pendingReward: '待领取',
      availableHint: '点击领取今日奖励，奖励会直接加入账户余额。',
      disabledHint: '每日签到当前已被管理员关闭。',
      claimedHint: '明天可再次领取。',
      claimButton: '领取奖励',
      disabledButton: '暂不可用',
      claimedButton: '已领取',
      claimSuccess: '签到成功，获得 {amount}',
      claimFailed: '签到失败',
      loadFailed: '加载签到状态失败',
    },
    avatar: {
  ...
  admin: {
    ...
    settings: {
      ...
      dailyCheckin: {
        title: '每日签到奖励',
        description: '配置用户每日签到可获得的余额奖励',
        enabled: '启用每日签到',
        minReward: '最低奖励',
        maxReward: '最高奖励',
        rewardHint: '奖励会在最低和最高金额之间随机生成，并直接加入用户余额。',
        rewardRangeError: '每日签到奖励必须是有效的非负数字。',
        maxRewardError: '每日签到最高奖励必须大于或等于最低奖励。',
      },
      quotaNotify: {
        title: '账号限额通知',
