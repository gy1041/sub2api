export default {
  ...
  profile: {
    ...
    dailyCheckin: {
      ...
      description: 'Claim a balance reward once per day',
      available: 'Available',
      disabled: 'Disabled',
      ...
      availableHint: 'Claim today’s reward and add it directly to your balance.',
      disabledHint: 'Daily check-in is currently disabled by the administrator.',
      claimedHint: 'You can claim again tomorrow.',
      claimButton: 'Claim Reward',
      disabledButton: 'Unavailable',
      claimedButton: 'Claimed',
      claimSuccess: 'Checked in and received {amount}',
      claimFailed: 'Check-in failed',
  ...
  admin: {
    ...
    settings: {
      ...
      dailyCheckin: {
        ...
        description: 'Configure the balance reward users can claim once per day',
        enabled: 'Enable Daily Check-in',
        minReward: 'Minimum Reward',
        maxReward: 'Maximum Reward',
        rewardHint: 'The reward is randomly generated between the minimum and maximum amount and added to the user balance.',
        rewardRangeError: 'Daily check-in rewards must be valid non-negative numbers.',
        maxRewardError: 'Daily check-in maximum reward must be greater than or equal to the minimum reward.',
      },
      quotaNotify: {
